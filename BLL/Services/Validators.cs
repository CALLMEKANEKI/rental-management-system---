...
namespace BLL.Services
{
    public static class Validators
    {
        ...
        public static bool ValidateChuTro(chutro chuTro, out string errorMessage)
        {
            ...
            {
                errorMessage = "Địa chỉ không được rỗng hoặc quá dài. (Tối đa 255 ký tự)";
                return false;
            }

            // 6. Kiểm tra tài khoản 
            if (!string.IsNullOrEmpty(chuTro.taikhoan) && chuTro.taikhoan.Length > 50)
            {
                errorMessage = "Tên tài khoản không được rỗng hoặc quá dài. (Tối đa 50 ký tự)";
                return false;
            }
            ...
            {
                errorMessage = "Mật khẩu không được rỗng hoặc quá dài. (Tối đa 20 ký tự)";
                return false;
            }
            return true;
        }
